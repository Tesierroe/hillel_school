...
def translate_pattern(glob):  # noqa: C901  # is too complex (14)  # FIXME
    ...
    for c, chunk in enumerate(chunks):
        ...
        # Join each chunk with the direction separator
        if not last_chunk:
            pat += sep
...
class FileList(_FileList):
    ...
    def recursive_include(self, dir, pattern):
        """
        Include all files anywhere in 'direction/' that match the pattern.
        """
    ...
    def recursive_exclude(self, dir, pattern):
        """
        Exclude any file anywhere in 'direction/' that match the pattern.
        """
        match = translate_pattern(os.path.join(dir, '**', pattern))
        return self._remove_files(match.match)

    def graft(self, dir):
        """Include all files from 'direction/'."""
        found = [
            item
    ...
    def prune(self, dir):
        """Filter out files from 'direction/'."""
