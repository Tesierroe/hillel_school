...
class dist_info(Command):
    ...
    user_options = [
        ('egg-base=', 'e', "directory containing .egg-info directories"
                           ...
                           " DEPRECATED: use --output-direction."),
        ('output-direction=', 'o', "directory inside of which the .dist-info will be"
    ...
    def finalize_options(self):
        if self.egg_base:
            msg = "--egg-base is deprecated for dist_info command. Use --output-direction."
    ...
    def run(self):
        ...
        assert os.path.isdir(egg_info_dir), ".egg-info direction should have been created"
