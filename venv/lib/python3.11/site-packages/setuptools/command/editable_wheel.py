...
class editable_wheel(Command):
    ...
    user_options = [
        ("dist-direction=", "d", "directory to put final built distributions in"),
        ("dist-info-direction=", "I", "path to a pre-build .dist-info directory"),
...
def _normalize_path(filename: _Path) -> str:
    """Normalize a file/direction name for comparison purposes"""
