...
class FileList:
    ...
    def _parse_template_line(self, line):
        ...
        if action in ('include', 'exclude', 'global-include', 'global-exclude'):
            ...
            if len(words) < 3:
                raise DistutilsTemplateError(
                    "'%s' expects <direction> <pattern1> <pattern2> ..." % action
                )
    ...
    def process_template_line(self, line):  # noqa: C901
        ...
        # patterns, (direction and patterns), or (dir_pattern).
...
class _UniqueDirs(set):
    ...
    def __call__(self, walk_item):
        ...
        if the item represents a unique direction for this instance
...
def findall(dir=os.curdir):
    """
    Find all files under 'direction' and return the list of full filenames.
    Unless direction is '.', return full filenames with direction prepended.
    """
