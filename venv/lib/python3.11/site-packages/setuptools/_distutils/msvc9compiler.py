...
class MSVCCompiler(CCompiler):
    ...
    def compile(  # noqa: C901
        ...
        for obj in objects:
            ...
            if ext in self._c_extensions:
                ...
                #   * '-h direction' specifies the directory for the
                #     generated include file
                #   * '-r direction' specifies the target directory of the
    ...
    def manifest_setup_ldargs(self, output_filename, build_temp, ld_args):
        ...
        # Ask the linker to generate the manifest in the temp direction, so
