    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'delattr', 'dict', 'direction', 'divmod', 'enumerate', 'eval', 'filter',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'cmp', 'coerce', 'compile', 'complex', 'delattr', 'dict', 'direction', 'divmod',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'dict', 'direction', 'divmod', 'enumerate', 'eval', 'execfile', 'exit',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'complex', 'delattr', 'direction', 'divmod', 'drop', 'dropwhile', 'enumerate',
